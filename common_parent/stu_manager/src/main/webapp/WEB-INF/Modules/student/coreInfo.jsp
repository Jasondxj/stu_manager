    ...
    <div class="total_table rel" style="margin-top: 20px">
        <table border="0" cellspacing="0" cellpadding="0"
            ...
            <tr>
                ...
                <td style="width: 80px"><p>课程名称</p></td>
                <td style="width: 20px"><p>成绩</p></td>
            </tr>
            </thead>
        </table>
            ...
            <table cellpadding="0" cellspacing="0" border="1"
                ...
                <c:forEach items="${cores}" var="core">
                    <tr onclick="Common.switchLine(this,event);">
                        <td style="width: 20px; text-align: center;"><p><span>${core.cno}</span></p></td>
                        <td style="width:80px; text-align: center;"><p><span>${core.course.name}</span></p></td>
                        <td style="width: 20px; text-align: center;"><p><span>${core.score}</span></p></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
