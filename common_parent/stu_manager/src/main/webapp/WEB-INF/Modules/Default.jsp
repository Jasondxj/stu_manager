				...
				<nav>
					<ul id="showMainNav" class="fix">
						<li class="navContent nav_current">
							...
							data-url="${pageContext.request.contextPath}/em/manage.do">基本数据管理</a>
						</li>
						<li class="navContent">
							<a href="#" class="showNav" id="finance" data-name="main_iframe"
							onclick="Common.switchNavigation(this);"
							data-url="${pageContext.request.contextPath}/student/manage.do">学生信息管理</a>
						</li>
                        <li class="navContent">
                            <a href="#" class="showNav" id="a" data-name="main_iframe"
                               onclick="Common.switchNavigation(this);"
                               data-url="${pageContext.request.contextPath}/employee/manage.do">学生成绩管理</a>
                        </li>
                        <li class="navContent">
                            <a href="#" class="showNav" id="a1" data-name="main_iframe"
                               onclick="Common.switchNavigation(this);"
                               data-url="${pageContext.request.contextPath}/employee/manage.do">学生信息查询与统计</a>
                        </li>
                        <li class="navContent">
                            <a href="#" class="showNav" id="a2" data-name="main_iframe"
                               onclick="Common.switchNavigation(this);"
                               data-url="${pageContext.request.contextPath}/user/manage.do">系统管理</a>
                        </li>
					</ul>
				</nav>
			</div>
